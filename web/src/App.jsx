        ...
        <div className="max-w-6xl mx-auto px-6 py-12 md:py-16">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 md:gap-12">
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-2.5">
                ...
                <span className="font-extrabold text-md tracking-tight text-white">Downloader</span>
              </div>
              <p className="text-xs text-slate-400 leading-relaxed">
                The ultimate open-source web media extraction companion. Piped and streamed on-the-fly directly to your browser client with no caching or disk storage.
              </p>
              <div className="pt-2">
            ...
            <div className="space-y-3">
              <h4 className="text-xs font-bold text-slate-200 uppercase tracking-widest">Downloader</h4>
            ...
            {/* Column 4: Legals */}
            <div className="space-y-3">
              <h4 className="text-xs font-bold text-slate-200 uppercase tracking-widest">Privacy & Safety</h4>
              <ul className="space-y-2 text-xs text-slate-400">
                <li className="flex items-center gap-1.5">
                  <Lock className="w-3.5 h-3.5 text-violet-400" />
                  <span>CORS Safe Integration</span>
                </li>
                <li className="flex items-center gap-1.5">
                  <Shield className="w-3.5 h-3.5 text-violet-400" />
                  <span>No Log Collection</span>
                </li>
                <li>
                  <button
                    onClick={() => {
          ...
          <div className="mt-12 pt-8 border-t border-slate-800 flex flex-col sm:flex-row items-center justify-between gap-4">
            <p className="text-[10px] text-slate-500 text-center sm:text-left leading-normal">
              © 2026 Downloader Hub. Powered by open GenDownload API proxy cluster. Hand-crafted with React & Tailwind.
            </p>
